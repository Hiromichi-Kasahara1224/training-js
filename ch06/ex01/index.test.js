import { newHashTable,hashStringToInt } from "./index.js";
...
describe('newHashTable', () => {
    ...
    test('ハッシュ衝突時も値を正しく取得・削除できる', () => {
      ...
      expect(hashStringToInt(key1,capacity)).toBe(hashStringToInt(key2,capacity));

      table.put(key1, 'value1');
      table.put(key2, 'value2');

      //console.log(JSON.stringify(table.entries, null, 2));
